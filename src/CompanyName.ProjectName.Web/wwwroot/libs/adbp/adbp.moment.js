...
(function () {
    ...
    abp.event.on('abp.dynamicScriptsInitialized', function () {
        abp.libs.moment.format.DATE = abp.setting.get("Adbp.Zero.LanguageTimeZone.DateFormatting").replace(/d/g, 'D').replace(/y/g, 'Y');
        abp.libs.moment.format.TIME = abp.setting.get("Adbp.Zero.LanguageTimeZone.TimeFormatting");
        abp.libs.moment.format.DATETIME = abp.setting.get("Adbp.Zero.LanguageTimeZone.DateTimeFormatting").replace(/d/g, 'D').replace(/y/g, 'Y');
    });
})();