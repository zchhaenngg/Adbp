...
{
    [AbpAuthorize(PermissionNames.Permissions_User)]
    public class UserAppService : ZeroAppServiceBase, IUserAppService
    {
        ...
        [AbpAuthorize(PermissionNames.Permissions_User_Retrieve)]
        ...
        [AbpAuthorize(PermissionNames.Permissions_User_Create)]
        ...
        [AbpAuthorize(PermissionNames.Permissions_User_Delete)]
        ...
        [AbpAuthorize(PermissionNames.Permissions_User_Update)]
